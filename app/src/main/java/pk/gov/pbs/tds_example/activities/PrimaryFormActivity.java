...
import pk.gov.pbs.tds_example.maps.PrimaryFormMap;
...
public class PrimaryFormActivity extends ActivitySection {
    @Override
    ...
    protected LabelProvider constructLabelProvider() {
        return new LabelProvider(this, "pf", LabelProvider.USA_LOCALE);
    }
